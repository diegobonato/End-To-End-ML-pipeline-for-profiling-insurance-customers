...
CREATE TABLE silver.insurance (
    ...
    AMT_Claim                   REAL,
    NB_Claim                    INTEGER,
    dwh_create_data         TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP -- This column is used to track when the record was created in the data warehouse
);
